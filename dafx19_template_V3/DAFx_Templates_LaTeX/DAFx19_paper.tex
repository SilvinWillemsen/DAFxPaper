...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[->,node distance=3cm,
    ...
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=1\columnwidth]{newPaperWaveform.eps}};
    \node (A) at (0.3, 2.8) {a)};
    \node (B) at (0.3, 1.2) {b)};
  \end{tikzpicture}
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[->,node distance=3cm,
    ...
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=1\columnwidth]{hysteresis3.eps}};
