...
\caption{\label{fft_plot}{\it A plot of the adhesion map $\alpha(v,z)$ when the signs of $v$ and $z$ are the same. The different regions are shown with the colours}}
\end{figure}
% %
% \begin{figure*}[ht]
% \center
